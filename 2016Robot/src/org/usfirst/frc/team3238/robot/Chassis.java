...
public class Chassis
{
    ...
    public void exist() {}
    public void setSpeed(double dubs) {
        try {
        this.leftMotorControllerA.set(dubs);
        }catch(Exception e) {
            DriverStation.reportError("LMA", true);
        }
        try
        {
            this.leftMotorControllerB.set(dubs);
        } catch(Exception e)
        {
            // TODO: handle exception
            DriverStation.reportError("LMB", true);
        }
        try
        {
            this.rightMotorControllerA.set(-dubs);
        } catch(Exception e)
        {
            DriverStation.reportError("RMA", true);
        }
        try
        {
            this.rightMotorControllerB.set(-dubs);
        } catch(Exception e)
        {
            DriverStation.reportError("RMB", true);
        }
    }
